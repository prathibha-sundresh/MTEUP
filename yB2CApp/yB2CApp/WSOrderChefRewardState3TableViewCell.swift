//
//  WSOrderChefRewardState3TableViewCell.swift
//  yB2CApp
//
...
//
  ...
  @objc protocol OrderChefRewardState3Delegate{
    func reloadTableViewAfterReedemGift()
  }
  
  class WSOrderChefRewardState3TableViewCell: UITableViewCell {
    ...
    var delegate:OrderChefRewardState3Delegate?
